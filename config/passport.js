            ...
            process.nextTick(function() {
                User.findOne({
                    ...
                    if (!user.validPassword(password))
                        return done(null, false, req.flash('loginMessage', 'La contraseña introducida no es correcta.'));
            ...
            process.nextTick(function() {
                ...
                if (!req.user) {
                    User.findOne({
                        ...
                        if (user) {
                            return done(null, false, req.flash('signupMessage', 'El correo introducido está ya en uso.'));
                        } else {
                    ...
                    User.findOne({
                        ...
                        if (user) {
                            return done(null, false, req.flash('loginMessage', 'El correo introducido está ya en uso.'));
